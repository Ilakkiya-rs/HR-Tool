...
const Register = () => {
  ...
  const handleSubmit = async (e: SyntheticEvent) => {
    ...
    if (referralCode) reqData.referral_code = referralCode;
    if (partnerId) reqData.partner_id = partnerId;
    if (currentExperienceLevel) reqData.current_experience_level = JSON.parse(currentExperienceLevel);
