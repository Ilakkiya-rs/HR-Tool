...
const Form = () => {
  ...
  useEffect(() => {
    ...
    const storedUserDetailsString = localStorage.getItem('loginUserDetail');
      ...
      if (sessionId) {
          ...
          .then(data => {
            if (data.is_payment_complete)  {
              ...
              localStorage.setItem('loginUserDetail', JSON.stringify(storedUserDetails));
  ...
  return (
    <>
      ...
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div className="m-3 flex flex-col lg:flex-row md:flex-row justify-end gap-3">
          <button
            onClick={addPerson}
