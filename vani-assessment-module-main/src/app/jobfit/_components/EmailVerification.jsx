...
const EmailVerification = ({token, languageCode}) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`https://api.myskillsplus.com/jobfit/verify/${token}/`, {
      // const response = await fetch(`http://127.0.0.1:8000/jobfit/verify/${token}/`, {
        method: "POST",
