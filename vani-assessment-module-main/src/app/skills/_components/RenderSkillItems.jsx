  ...
  return (
    <div>
              ...
              {skills.length > 1 && (
                <div className="flex-shrink-0">
                  <button
                    ...
                    className="text-[#F44336] hover:text-[#D32F2F] hover:cursor-pointer"
                  >
      ...
      <button
        ...
        className="px-4 py-2 bg-indigo-100 text-indigo-700 rounded-md hover:bg-indigo-200 transition-colors hover:cursor-pointer"
      >
