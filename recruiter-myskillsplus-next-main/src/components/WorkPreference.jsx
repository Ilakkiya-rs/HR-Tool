...
export default function WorkPreferencePage() {
  ...
  useEffect(() => {
    const fetchWorkPreference = async () => {
      try {
        // const res = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/users/get-work-preference/?userId=${userId}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // const res = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/users/submit-work-preference/`, {
  ...
  return loading ? (
    ...
    <>
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div className="p-4 rounded-2xl bg-white text-[#24303F]">
                    <h2 className="text-lg font-semibold mb-4">Other Career Development</h2>
                    <h2 className="text-base font-medium mb-3">Open to Doing</h2>
                    <div className="flex flex-col gap-2 text-sm">
                        {Array.isArray(workPreference?.otherCareer) && workPreference.otherCareer.length > 0 ? (
                        workPreference.otherCareer.map((item, index) => (
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="border border-[#D3D9E2] rounded-xl p-4">
                        ...
                        <div className="mb-2">
                            <div className="grid md:grid-cols-2 gap-6">
                                <div>
                                    <h3 className="text-sm font-semibold mb-2">Are you willing to relocate?</h3>
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
        <div className="grid grid-cols-3 gap-4 text-sm">
            ...
            <div className="col-span-2 p-4 rounded-2xl bg-white text-[#24303F]">
                <h2 className="text-lg font-semibold mb-4">Work Interest</h2>
            ...
            {/* Other Career Development (Multi-select) */}
            <div className="p-4 rounded-2xl bg-white text-[#24303F]">
                <h2 className="text-lg font-semibold mb-4">Other Career Development</h2>
                <h2 className="text-base font-medium mb-3">Open to Doing</h2>
                <div className="flex flex-row gap-4 text-sm">
                    {["Mentoring", "Interviews / Assessments"].map((career) => (
                    <label key={career} className="flex items-center gap-2">
                        <input
                        type="checkbox"
                        name="otherCareer"
                        value={career}
                        checked={workPreference.otherCareer.includes(career)}
                        onChange={() => handleMultiCheckboxChange('otherCareer', career)}
                        />
                        <span>{career}</span>
                    </label>
                    ))}
        ...
        <div className="p-4 bg-white shadow rounded-2xl text-[#24303F]">
            ...
            <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="border border-[#D3D9E2] rounded-xl p-4">
                    ...
                    {/* Employment Type */}
                    <div className="flex flex-row gap-10 mb-4 text-[13px]">
                    ...
                    {/* Current Location */}
                    <div className="mb-4">
                        <h3 className="text-sm font-semibold mb-4">Where are you currently located?</h3>
                    ...
                    <div className="mb-4">
                        ...
                        {workPreference.willingToRelocate === "Yes" && (
                            <div className="mt-4">
                                <h3 className="text-sm font-medium mb-2">Where are you open to moving?</h3>
                                {["Within my State/Province", "Anywhere within my Country", "Other Countries (International relocation)"].map((relocation) => (
                                    <label key={relocation} className="flex items-center gap-2 mb-2 text-sm">
                                        ...
                                        onChange={() => handleSingleCheckboxChange('relocationPreference', relocation)}
                                        />
                                        {relocation}
                                    </label>
                                ))}
