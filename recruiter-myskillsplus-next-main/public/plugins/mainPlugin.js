...
console.log("activNave: ", activeNav);
...
class IysFunctionalAreasPlugin extends IysSearchPlugin {
    ...
    setupDiv() {
        ...
        if(activeNav=="Home" || activeNav==null){
        ...
        if(activeNav!="Export" && activeNav!="Profile"){
        ...
        else if(activeNav=="Feedback" || activeNav==null){
        ...
        if(activeNav=="Feedback" || activeNav==null){
