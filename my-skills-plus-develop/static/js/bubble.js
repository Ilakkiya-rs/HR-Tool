function BubbleChart(
  data,
  {
    ...
    colors = d3.schemeSet2, // an array of colors (for groups)
  ...
  const leaf = svg
    ...
    .attr("data-mdb-toggle", (d) => `popover`)
    .attr("data-mdb-trigger", (d) => `hover`)
    .attr("data-mdb-content", (d)=> L[d.data]);
  ...
  if (L) {
    ...
    leaf
      ...
      .join("tspan")
      .attr("x", 0)
      .attr("y", (d, i, D) => `${i - D.length / 2 + 1}em`)
