...
</svg>  ${sumofAllRatings} element added to your profile <span "text-primary>Check your profile</span>`;
  } else {
...
class IysFunctionalAreasPlugin extends IysSearchPlugin {
  ...
  setupDiv() {
    ...
    cardDiv.className = "bg-trnasparent";
    ...
    homeButton.className = "nav-link px-4 py-3";
    ...
    profileButton.className = "nav-link px-4 py-3 active";
    ...
    containerFluidDiv.className = "pb-md-3";
    ...
    btnGroupDiv.className = "btn-group shadow-0 bg-white";
    ...
    tabContentDiv3.className = "tab-content card shadow-0 p-3";
    ...
    var containerFluidDiv = document.createElement("div");
    containerFluidDiv.className = "container-fluid pb-md-3";
