...
const featuresData = [
  {
    ...
    title: 'Efficiency',
    description: 'Higher level of engagement with users'
  },
  {
    icon: 'flaticon-lightbulb',
    title: 'Engagement',
    description: 'Hyper personalization'
  },
  {
    ...
    <div className="container">
      <Row className="align-items-center">
        <Col lg="4">
          <div>
            <h2 className="mb-0">
              <span className="font-w-4 d-block">Outcomes </span> For You
            </h2>
          </div>
        </Col>
      </Row>
        ...
        {featuresData.map((feature, index) => (
          <Col key={index} lg="4" md="6" mt-lg="0">
            <div className="p-5" style={{ backgroundColor: '#d0faec' }}>
              ...
              <h5 className="mt-4" style={{ height: '50px' }}>
                {feature.description}
              </h5>
            </div>
          </Col>
