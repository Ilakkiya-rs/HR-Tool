  ...
  return (
    <>
      ...
      <div className="container">
        <br />
        <h2> Skills Profiler Plugin with proficiency rating </h2>
        <br />
        <Card>
          <Card.Body>
            <Card.Title>
              ...
              <Card.Body>
                ...
                <ol>
                  <li>
                    ...
                    <a
                      className="mx-2"
                      href="https://github.com/itsyourskills-repos/iys-plugin-rating/blob/master/master/index.html"
                    >
                      index.html
                    </a>
                    <br></br>
